export const questions = [
    {
      text: "What made you pick up the guitar?",
      options: [
    ...
    {
      text: "How’s your practice schedule?",
      options: [
    ...
    {
      text: "What happens when someone asks you to ‘play something’?",
      options: [
    ...
    {
      text: "What’s your guitar gear situation?",
      options: [
        { label: "A carefully curated tone temple. Don’t touch anything.", type: "The Nerd" },
        { label: "I bought whatever was in the starter pack. Still works.", type: "The Someday Player" },
        { label: "All aesthetic. I may not play it, but it photographs beautifully.", type: "The Poser" },
        { label: "I have a capo, a journal, and dreams.", type: "The Artist" }
      ]
    },
    {
    ...
    {
      text: "What’s the most likely reason you’d stop playing again?",
      options: [
        { label: "Life. Work. Netflix. You name it.", type: "The Someday Player" },
        { label: "Got distracted by a new hobby (hello, pottery).", type: "The Hobby Hopper" },
        { label: "I overanalyzed everything and forgot to have fun.", type: "The Nerd" },
        { label: "Lost momentum after one ‘bad’ day.", type: "The Eternal Restarter" }
      ]
    },
    {
